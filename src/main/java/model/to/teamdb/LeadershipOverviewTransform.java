 ...
 */
@Entity
@Table(name = "LEADERSHIP_OVERVIEW_TRANSFORM", catalog = "")
public class LeadershipOverviewTransform {
    private String id;
    ...
    private Long orderInLeadership;
    ...
    public boolean equals(Object o) {
        ...
        LeadershipOverviewTransform that = (LeadershipOverviewTransform) o;
    ...
    @Basic
    @Column(name = "LEADERSHIP_ID", nullable = true, length = 50)
    ...
    @Basic
    @Column(name = "ORDER_IN_LEADERSHIP", nullable = true, precision = 2)
    public Long getOrderInLeadership() {
        return orderInLeadership;
    }

    public void setOrderInLeadership(Long orderInLeadership) {
