...
public class CodeTable {
    ...
    public boolean equals(Object o) {
        ...
        if (id != null ? !id.equals(codeTable.id) : codeTable.id != null) return false;
        if (code != null ? !code.equals(codeTable.code) : codeTable.code != null) return false;
        if (codeType != null ? !codeType.equals(codeTable.codeType) : codeTable.codeType != null) return false;
        if (conditionName != null ? !conditionName.equals(codeTable.conditionName) : codeTable.conditionName != null)
            return false;
        if (conditionNameEnglish != null ? !conditionNameEnglish.equals(codeTable.conditionNameEnglish) : codeTable.conditionNameEnglish != null)
            return false;
        if (description != null ? !description.equals(codeTable.description) : codeTable.description != null)
            return false;
